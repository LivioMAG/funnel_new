...
function normalizeListPresentation(presentation) {
  if (presentation === 'vertical' || presentation === 'icon-text-vertical' || presentation === 'icon-top') return 'icon-text-vertical';
  if (presentation === 'horizontal' || presentation === 'icon-left') return 'icon-left';
  return 'default';
}
...
function renderSection(s) {
  ...
  if (s.type === 'list') {
    ...
    const presentation = normalizeListPresentation(s.itemPresentation);
